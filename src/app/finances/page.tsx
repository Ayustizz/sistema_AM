...
import { Plus, DollarSign, TrendingDown, Loader2 } from "lucide-react";
...
export default function FinancesPage() {
  ...
  const load = useCallback(async () => {
    ...
    const { data } = await get<unknown>(`/api/finances?from=${monthStart}`);
    if (data) {
    ...
    <AppLayout title="Finanzas">
      <div className="space-y-5 animate-fade-in">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <Card>
            <CardContent className="p-5">
              <p className="text-xs text-gray-500 uppercase font-medium">Mayor Gasto</p>
              ...
              <p className="text-xs text-gray-400 mt-0.5">Categoría principal</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-5">
              <p className="text-xs text-gray-500 uppercase font-medium">Promedio por gasto</p>
              <p className="text-2xl font-bold mt-1">
        ...
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-medium text-gray-700">Gastos del mes</h2>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-semibold text-gray-700">Por Categoría</CardTitle>
            </CardHeader>
            <CardContent>
              {pieData.length > 0 ? (
          ...
          <DialogContent>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <Input value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} placeholder="Ej: Alquiler local, sueldo, ..." />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input type="number" value={form.amount} onChange={(e) => setForm({ ...form, amount: e.target.value })} className="pl-7" placeholder="0" />
                  </div>
                </div>
                <div className="space-y-1.5">
                  <Label>Fecha</Label>
